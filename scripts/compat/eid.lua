...
if EID then
    -- Main info
    EID:setModIndicatorName("Simon")

    -- local simonIcon = Sprite()
    -- simonIcon:Load("gfx/eid_player_icons.anm2", true)
    -- EID:addIcon(, "Players", 0, 16, 16, 0, 0, simonIcons)
    -- EID:setModIndicatorIcon()
    ...
    EID:addCollectible(Enums.Items.SIPPY_CAP, "Grants {{Collectible330}} Soy Milk, {{Collectible561}} Almond Milk or {{Collectible69}} Chocolate Milk for current room", "Sippy Cap", "en_us")
end
